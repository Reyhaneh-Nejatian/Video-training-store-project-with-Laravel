...
class LessonTest extends TestCase
{
    ...
    public function test_permitted_user_can_update_lesson()
    {
        ...
        $this->assertEquals("updated title",Lesson::query()->find(1)->title);
    ...
    public function test_permitted_user_can_destroy_lesson()
    {
        ...
        $this->assertEquals(null,Lesson::query()->find(1));

        $this->actAsUser();
        $this->delete(route('lessons.destroy',[1,2]))->assertStatus(403);
        $this->assertEquals(1,Lesson::query()->whereId(2)->count());
    ...
    public function test_permitted_user_can_destroy_multiple_lessons()
    {
        ...
        $this->assertEquals(null,Lesson::query()->find(1));
        $this->assertEquals(null,Lesson::query()->find(2));
        $this->assertEquals(3,Lesson::query()->find(3)->id);
    ...
    public function test_permitted_user_can_accept_lesson()
    {
        ...
        $course = $this->createCourse();
        $lesson = $this->createLesson($course);
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_PENDING,Lesson::query()->find(1)->confirmation_status);
        $this->patch(route('lessons.accept',$lesson->id));
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_ACCEPTED,Lesson::query()->find(1)->confirmation_status);
    ...
    public function test_permitted_user_can_accept_all_lessons()
    {
        ...
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_PENDING,Lesson::query()->find(1)->confirmation_status);
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_PENDING,Lesson::query()->find(2)->confirmation_status);
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_PENDING,Lesson::query()->find(3)->confirmation_status);
    ...
    public function test_permitted_user_can_accept_multiple_lessons()
    {
        ...
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_ACCEPTED,Lesson::query()->find(1)->confirmation_status);
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_ACCEPTED,Lesson::query()->find(2)->confirmation_status);
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_PENDING,Lesson::query()->find(3)->confirmation_status);
    ...
    public function test_permitted_user_can_reject_lesson()
    {
        ...
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_REJECTED,Lesson::query()->find(1)->confirmation_status);
    ...
    public function test_permitted_user_can_reject_multiple_lessons()
    {
        ...
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_REJECTED,Lesson::query()->find(1)->confirmation_status);
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_REJECTED,Lesson::query()->find(2)->confirmation_status);
        $this->assertEquals(Lesson::CONFIRMATION_STATUS_PENDING,Lesson::query()->find(3)->confirmation_status);
    ...
    public function test_permitted_user_can_lock_lesson()
    {
        ...
        $this->assertEquals(Lesson::STATUS_LOCKED,Lesson::query()->find(1)->status);
        $this->assertEquals(Lesson::STATUS_OPENED,Lesson::query()->find(2)->status);
    ...
    public function test_permitted_user_can_unlock_lesson()
    {
        ...
        $this->assertEquals(Lesson::STATUS_LOCKED,Lesson::query()->find(2)->status);
