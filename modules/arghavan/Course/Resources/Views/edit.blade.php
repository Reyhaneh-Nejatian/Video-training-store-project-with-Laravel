            ...
            <form action="{{ route('courses.update', $course->id) }}" class="padding-30" method="post" enctype="multipart/form-data">
                ...
                <div class="d-flex multi-text">
                    <x-input type="text" class="text-left mlg-15" name="priority"
                             value="{{ $course->priority }}" placeholder="ردیف دوره"></x-input>
                ...
                <x-select name="type" required>
                    ...
                    @foreach(arghavan\Course\Models\Course::$types as $type)
                        <option value="{{ $type }}"
                ...
                <x-select name="status" required>
                    ...
                    @foreach(\arghavan\Course\Models\Course::$statuses as $status)
                        <option value="{{ $status }}"
