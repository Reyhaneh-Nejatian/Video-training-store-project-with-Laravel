...
@section('content')
    ...
    @can(\arghavan\RolePermissions\Models\Permission::PERMISSION_TEACH)
        <div class="row no-gutters font-size-13 margin-bottom-10"pa>
        ...
        <div class="row no-gutters font-size-13 margin-bottom-10">
            ...
            <div class="col-3 padding-20 border-radius-3 bg-white  margin-bottom-10">
                ...
                <p>{{ $todaySuccessPaymentsTotal }} تومان</p>
            </div>
        </div>
        <div class="row no-gutters font-size-13 margin-bottom-10">
