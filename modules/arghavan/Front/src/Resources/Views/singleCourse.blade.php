                    ...
                    <div class="course-teacher-details">
                        <div class="top-part">
                            <a href="{{ route('singleTutor',$course->teacher->username) }}">
                                <img alt="{{ $course->teacher->name }}" class="img-fluid lazyloaded" src="{{ $course->teacher->thumb }}" loading="lazy">
                                <noscript>
        ...
        function checkDiscountCode()
        {
            ...
            $.get(url.replace('code',code))
                .done(function (data){
                    ...
                    $('#payableAmount').text(parseInt($("#payableAmount").attr("data-value")) - data.payableAmount)
